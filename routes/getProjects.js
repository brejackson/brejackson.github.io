...
function(req, res){
  ...
  // Build the get request 
     var options = {
      ...
      //url: 'https://rally1.rallydev.com/slm/webservice/v2.0/Project?workspace/"+workspaceID+"&query=(ObjectID = 23724738313)&pagesize=200',
      url: 'https://rally1.rallydev.com/slm/webservice/v2.0/workspace/23724738313/Projects',
     // url: 'https://rally1.rallydev.com/slm/webservice/v2.0/Project?workspace/6881649215u23724738313w3&pagesize=200',
      //url: 'https://rally1.rallydev.com/slm/webservice/v2.0/Project?workspace/"+workspaceID+"&query=(Parent.ObjectID = 247223054280)&pagesize=200',
      //url: 'https://rally1.rallydev.com/slm/webservice/v2.0/Project?project/247223054280',
     // url: 'https://rally1.rallydev.com/slm/webservice/v2.0/Project?objectid=247223054280&pagesize=200',
...
*/
  request(options, function (error, response, body) {
    if (!error) {
        ...
        console.log('Project: ', projectsJSON);
